...
最新发行版为 `v1.2.13`。下载 `releases/sh-iptv-spider-installer-1.2.13-linux-amd64.tar.gz` 后执行：

```bash
tar -xzf sh-iptv-spider-installer-1.2.13-linux-amd64.tar.gz
...
`7ea8dff60a0125cd089fc6c1c8d9be8818aa13c3b45715757a13f19edc65f777`。

也可使用一键安装脚本：

```bash
curl -fsSL https://github.com/driftbottle61/sh-iptv-manager/releases/download/v1.2.13/install-oneclick.sh | sudo bash
```
