...
最新发行版为 `v1.2.12`。下载 `releases/sh-iptv-spider-installer-1.2.12-linux-amd64.tar.gz` 后执行：

```bash
tar -xzf sh-iptv-spider-installer-1.2.12-linux-amd64.tar.gz
...
`17da737c2d175f2d90103aa86698894de0baf789722c24d1ae7a2d36083c354f`。

也可使用一键安装脚本：

```bash
curl -fsSL https://github.com/driftbottle61/sh-iptv-manager/releases/download/v1.2.12/install-oneclick.sh | sudo bash
```
